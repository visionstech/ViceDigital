    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Domain" class="form-control col-md-7 col-xs-12" name="website" value="<?php echo e(old('website')); ?>">
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Name" class="form-control col-md-7 col-xs-12" name="name" value="<?php echo e(old('name')); ?>">
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="email" placeholder="Email" class="form-control col-md-7 col-xs-12" name="email" value="<?php echo e(old('email')); ?>">
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <?php foreach($products as $product): ?>
                ...
                <label><?php echo e($product_name); ?></label><br>
            <?php endforeach; ?>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Adunit ID" class="form-control col-md-7 col-xs-12" name="adunit_id" value="<?php echo e(old('adunit_id')); ?>">
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Krux ID" class="form-control col-md-7 col-xs-12" name="krux_id" value="<?php echo e(old('krux_id')); ?>">
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Comscore ID" class="form-control col-md-7 col-xs-12" name="comscore_id" value="<?php echo e(old('comscore_id')); ?>">
        </div>
        <div class="clearfix"></div>
    </div>

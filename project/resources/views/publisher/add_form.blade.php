    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Slot name" class="form-control col-md-7 col-xs-12" name="slotname" value="{{ old('slotname') }}">
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="text" placeholder="Container" class="form-control col-md-7 col-xs-12" name="container" value="{{ old('container') }}">
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
